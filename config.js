...
global.snh = 'https://www.youtube.com/channel/UCMx4e8anOq_Olt2nMSv0w' // my youtube channel
...
global.ppulsa2 = '083105060768' // kalau ada kartu lain isi aja
...
/*============== Github Thanks To ==============*/
global.namagithub = 'Lucife-Putra' // nama github lu
...
/*============== WATERMARK ==============*/
global.wm = '                「 KaylaBot 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘KaylaBotz˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ PUTRAMODZ404X9INVISIBL'
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By PUTRAMODZ404XKYAL4B0TZ`
